...
import { Loader2, Rocket, DollarSign, Clock, User, Mail, Phone, Building, CheckCircle, ArrowLeft } from "lucide-react";
...
const CustomQuote = () => {
  ...
  return (
    <>
      <SEOHead
        title="Get Custom Quote - Lee Grant Developer"
        description="Get a personalized quote for your custom web development project. Tell us about your vision and we'll provide a detailed estimate within 24 hours."
        keywords="custom quote, web development quote, project estimate, bespoke development, custom software"
        url="https://leegrantdev.com/custom-quote"
      />
        ...
        <main className="pt-20 pb-16">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-orange to-orange/80 bg-clip-text text-transparent mb-4">
