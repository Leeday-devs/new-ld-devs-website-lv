...
const Services = () => {
  const services = [{
    ...
    features: ["Up to 10 Pages", "Easy Shopping Cart", "Safe Payment System", "AI Chat Bot", "Inventory Tracking", "Customer Messages"],
    price: "£800",
    monthlyPrice: "£60",
    ...
    icon2: ShoppingCart,
    pricingFeatures: ["Up to 10 Pages", "Advanced Contact Forms", "Complete SEO Package", "Custom Animations", "Database Integration"]
  }, {
    icon: Brain,
