                  ...
                  <div className={`relative z-10 h-full flex flex-col text-white ${index < 4 ? 'p-6' : 'p-3'}`}>
                    ...
                    <div className={`${index < 4 ? 'space-y-3' : 'space-y-1'} mt-auto`}>
                      {service.title === "Build Me a Website" ? (
                        ...
                        <Button onClick={() => console.log('See Details clicked for:', service.title)} className={`w-full bg-white text-gray-900 hover:bg-gray-100 transition-all duration-200 rounded-xl font-semibold ${index < 4 ? 'py-3 text-sm' : 'py-2 text-xs'} shadow-lg border-0 flex items-center justify-center`}>
