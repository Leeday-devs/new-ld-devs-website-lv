...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      aria-modal="true"
      className={cn(
        "fixed left-[50%] top-[50%] z-50 -translate-x-1/2 -translate-y-1/2 modal-content modal-default focus:outline-none data-[state=open]:animate-[modal-content-in_var(--modal-content-duration)_ease-out] data-[state=closed]:animate-[modal-content-out_var(--modal-content-duration)_ease-out] max-h-[90vh] overflow-y-auto",
        className
      )}
      tabIndex={-1}
      {...props}
